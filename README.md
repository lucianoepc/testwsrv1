...
#Crear una un archivo solución 'testwsrv1.sln' en la ruta actual
dotnet new sln --name testwsrv1
...
<PropertyGroup>
    ...
    <RootNamespace>PoC.TestWSrv1.WebServices</RootNamespace>
    <AssemblyName>PoC.TestWSrv1.WebServices</AssemblyName>
</PropertyGroup>
```
